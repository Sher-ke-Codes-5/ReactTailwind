...
const Form = () => {
  ...
  return (
    <div className="flex flex-col md:mr-10 md:w-[100%]  w-[90%]  bg-slate-100">
      <div className="  flex justify-center items-center text-white flex-row w-full ">
        <form className="space-y-4">
          <input
            ...
            value={user.search}
            className="w-auto rounded-full md:ml-10 mt-10 text-white bg-yellow-300 flex md:px-12 py-2 px-12 focus:border-transparent focus:outline-none"
            id="search"
            autoComplete="off"
          />
        </form>
        <div className="absolute   md:right-12 right-7 pr-[3rem] pt-[40px] md:pr-3 text-white flex ">
          <SlMagnifier />
        </div>
      </div>
      ...
      <div className="flex flex-col md:w-auto w-[90%] justify-center items-center rounded-full">
        ...
        <h1 className="md:text-2xl w-72 ml-10 pl-12 text-white flex bg-yellow-300 mt-8">
          Popular Posts
        </h1>
        <Cards />
        ...
        <ul>
          <Link to="#">
            <li className="flex gap-[11rem] mt-5 bg-slate-100 w-72 ml-14 items-center  text-gray-700  ">
              <p>Technology</p>
              <p>37</p>
            </li>
          </Link>
          <Link to="#">
            <li className="flex gap-[14.5rem] mt-5 bg-slate-100 w-72 ml-14 items-center  text-gray-700  ">
              Art <p>29</p>
            </li>
          </Link>
          <Link to="#">
            <li className="flex gap-[12.3rem] mt-5 bg-slate-100 w-72 ml-14 items-center  text-gray-700  ">
              Lifestyle <p>34</p>
            </li>
          </Link>
          <Link to="#">
            <li className="flex gap-[12.5rem] mt-5 bg-slate-100 w-72 ml-14 items-center  text-gray-700  ">
              Fashion <p>44</p>
            </li>
          </Link>
        </ul>

        <h1 className="md:text-2xl w-72 ml-10 pl-20 text-white flex bg-yellow-400 mt-8">
          New Letter
        </h1>
        ...
        <div class="md:ml-10 ml-10 mt-6 h-10 flex flex-row ">
          <MdEmail className="md:right-[19rem] mt-3  absolute" />
          <form className="space-y-4 ">
            <input
              type="text"
              name="email"
